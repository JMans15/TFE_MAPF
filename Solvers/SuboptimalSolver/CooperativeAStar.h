...
//
// typeOfHeuristic is the heuristic for the single agent A* searches :
// - Manhattan (Cooperative A*) or
// - OptimalDistance (Hierarchical Cooperative A* with a Reverse Resumable A*)
//
