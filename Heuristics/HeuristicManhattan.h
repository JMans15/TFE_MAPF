...
public:
  SICheuristic(std::vector<int> targets, int width)
      : targets(targets), width(width) {}
...
public:
  MICheuristic(std::vector<int> targets, int width)
      : targets(targets), width(width) {}
...
public:
  MICheuristic2(std::vector<int> targets, int width)
      : targets(targets), width(width) {}
