...
bool ODMultiAgentAStarProblemWithConstraints::notAlreadyOccupiedPosition(int position, std::vector<int> &positions, int agentToAssign) const {
...
bool ODMultiAgentAStarProblemWithConstraints::notAlreadyOccupiedEdge(int position, const std::vector<int> &positions, int agentToAssign, const std::vector<int> &prePositions) const{
    for (int i = 0; i < agentToAssign; i++) {
...
std::shared_ptr<MultiAgentProblem> ODMultiAgentAStarProblemWithConstraints::getProblem() {
    return problem;
}