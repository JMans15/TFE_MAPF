...
public:
    ...
    ODMultiAgentSpaceTimeState(const std::vector<int>& positions, std::vector<int> prePositions, int timestep, int agentToAssign, bool standard, const std::vector<u_int8_t>& cannotMove = std::vector<u_int8_t>());
