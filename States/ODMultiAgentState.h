...
protected:
  ...
  // positions[agentToAssign] is not yet assigned but will be in the successor
  // state.
  ...
  // positions and prePositions are equal at standard states (when all agents
  // have been assigned). prePositions is just needed to avoid Edge Conflict
  // (implemented in the getSuccessors function).
